...
test.describe('Ethical comparison visual contract @visual', () => {
  test('Ethical comparison brief', async ({ page }, testInfo) => {
    ...
    await expectVisual(page.locator('.ethical-comparison'), 'ethical-comparison-brief', testInfo)
  })

  test('Ethical comparison completed results', async ({ page }, testInfo) => {
    ...
    const resultValues = page.locator('.ethical-result-grid dd')
    await expectVisual(
      page.locator('.ethical-comparison'),
      'ethical-comparison-results',
      testInfo,
      [resultValues.nth(6), resultValues.nth(13), page.locator('.comparison-session-meta')],
    )
  })
})
